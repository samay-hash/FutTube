    ...
    <main className="min-h-screen w-full flex bg-background text-foreground overflow-hidden">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-medium ml-1 uppercase tracking-wider text-muted-foreground">Email address</label>
              <input
                type="email"
                value={email}
      ...
      >
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-l from-black/80 to-transparent mix-blend-multiply" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent" />

        <div className="absolute bottom-16 right-12 max-w-lg z-10 text-right text-white">
          <motion.h2
          ...
          <motion.p
            ...
            className="text-white/70 text-lg leading-relaxed max-w-md ml-auto"
          >
            Pick up right where you left off. Your studio is ready.
          </motion.p>
        </div>
      </motion.div>
